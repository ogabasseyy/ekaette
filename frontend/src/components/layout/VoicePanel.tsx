  ...
  return (
    <section className="panel-glass flex min-h-0 flex-col justify-between px-4 py-4 sm:px-5 sm:py-5">
      ...
      <div className="mt-4 rounded-2xl border border-border/70 bg-black/30 p-3.5 sm:mt-5 sm:p-5">
        <div className="mx-auto flex max-w-xs flex-col items-center gap-4">
          ...
          <div className="text-center">
            <p className="font-semibold text-2xl text-white">{formatDuration(elapsedSeconds)}</p>
      ...
      <div className="mt-4 space-y-2">
        <p className="rounded-xl border border-border/70 bg-card/50 px-3 py-2 text-[11px] text-muted-foreground leading-5 sm:text-xs">
